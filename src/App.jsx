...
const generatedBathroomSeeds = [
  ...
  ['Chinatown', 'San Francisco, CA', 37.7941, -122.4078],
  ['North Beach', 'San Francisco, CA', 37.8061, -122.4103],
  ['Financial District', 'San Francisco, CA', 37.7946, -122.3999],
  ['Russian Hill', 'San Francisco, CA', 37.8024, -122.4192],
  ['Pacific Heights', 'San Francisco, CA', 37.7924, -122.4382],
  ['Cow Hollow', 'San Francisco, CA', 37.7989, -122.4366],
  ['Presidio Heights', 'San Francisco, CA', 37.7866, -122.459],
  ['Noe Valley', 'San Francisco, CA', 37.7502, -122.4337],
  ['Castro', 'San Francisco, CA', 37.7609, -122.435],
  ['Bernal Heights', 'San Francisco, CA', 37.7416, -122.4156],
  ['Potrero Hill', 'San Francisco, CA', 37.7596, -122.3991],
  ['Dogpatch', 'San Francisco, CA', 37.7589, -122.3882],
  ['Outer Sunset', 'San Francisco, CA', 37.7534, -122.4944],
  ['Outer Richmond', 'San Francisco, CA', 37.7799, -122.4925],
  ['West Portal', 'San Francisco, CA', 37.7403, -122.4661],
  ['Glen Park', 'San Francisco, CA', 37.7368, -122.4337],
  ['Excelsior', 'San Francisco, CA', 37.7244, -122.4318],
  ['Bayview', 'San Francisco, CA', 37.7297, -122.3928],
  ['Visitacion Valley', 'San Francisco, CA', 37.7148, -122.4042],
  ['Treasure Island', 'San Francisco, CA', 37.824, -122.37],
